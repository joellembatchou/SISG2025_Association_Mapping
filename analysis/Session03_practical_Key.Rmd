---
title: "Practical 3 Key - GWAS in Samples with Structure & Using REGENIE"
author: ""
date: ""
...
# cleanup
file.remove("gwas_plink.Pheno.glm.linear")
file.remove(list.files(pattern = "gwas_regenie_[0-9a-z]*"))
file.remove(list.files(pattern = "step2_gwas_regenie_[0-9a-z]*"))
file.remove(list.files(pattern = "qc_pass*"))
```